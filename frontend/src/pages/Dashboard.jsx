...
import { ADD_BUTTON, HEADER, ICON_WRAPPER, STAT_CARD, STATS, STATS_GRID, VALUE_CLASS, WRAPPER, LABEL_CLASS, FILTER_WRAPPER, FILTER_LABELS, SELECT_CLASSES, FILTER_OPTIONS, TABS_WRAPPER, TAB_BASE, TAB_ACTIVE, TAB_INACTIVE, EMPTY_STATE } from '../assets/dummy'
    ...
    <div className={WRAPPER}>
      ...
      <div className='space-y-6'>
        ...
        <div
         ...
         rounded-x1 hover:border-purple-400 bg-purple-50/50 cursor-pointer transition-colors'>
