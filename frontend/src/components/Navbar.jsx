   ...
   border-b border-gray-200 font-sans'>
    <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
        ...
        onClick={() => navigate('/')}>
            ...
            {/* LOGO TEXT */}
            <span className='text-xl font-extrabold bg-gradient-to-r from-fuchsia-500 via-purple-500 
        ...
        <div className='flex items-center gap-4'>
            ...
            <div ref = {menuref} className='relative'>
                ...
                {menuOpen && (
                    <ul className='absolute right-0 top-14 mt-2 w-56 bg-white rounded-2xl shadow-xl
                    border border-purple-100 overflow-hidden z-50 animate-fadeIn'>
                        <li className='p-2'>
                            <button onClick={() =>{
                                setMenuOpen(false)
                                navigate('/profile')
                            }}
                            className='w-full text-left px-4 py-2.5 text-left hover:bg-purple-50 text-sm
