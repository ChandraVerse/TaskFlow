...
const Layout = ({onLogout, user}) => {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      console.log("Token used for fetchTasks:", token);
      if (!token) {
        onLogout();
        return;
      }
  ...
  const StatCard = ({ title, value, icon }) => (
    <div className=' p-2 sm:p-3 rounded-x1 bg-white shadow-sm border border-purple-100 hover: shadow-md transition-all
    duration-300 hover: border-purple-100 group'>
      <div className=' flex items-center gap-2'>
       <div className=' p-1.5 rounded-1g bg-gradient-to-br from-fuchsia-500/10 to-purple-500 group-hover:from-fuchsia-500/20
       group-hover:to-purple-500/20'>
        {icon}
       </div>
       <div className='min-w-0'>
        <p className='text-1g sm: text-x1 font-bold bg-gradient-to-r from-fuchsia-500 Ito-purple-600
  ...
  // ERROR
    if (error) return(
      <div className=' min-h-screen bg-gray-50 p-6 flex items-center justify-center'>
        <div className='bg-red-50 Itext-red-600 p-4 rounded-x1 border border-red-100 max-w-md'>
          <p className=' font-medium mb-2'>Error loading tasks</p>
          <p className=' text-sm'>{error}</p>
          <button onClick={fetchTasks} className=' mt-4 py-2 px-4 bg-red-100 text-red-700 rounded-1g
    ...
    <div className='min-h-screen bg-gray-50'>
        ...
        <div className='ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300'>
          <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
            ...
            <div className=' x1:col-span-1 space-y-4 sm: space-y-6'>
              <div className='bg-white rounded-x1 p-4 sm:p-5 shadow-sm border border-purple-100'>
                <h3 className=' text-base sm: text-1g font-semibold mb-3 sm:mb-4 text-gray-800
                ...
                <div className='space-y-2 sm:space-y-3'>
                  ...
                  <div className='relative pt-1'>
                    <div className='flex gap-1.5 items-ccenter'>
              ...
              <div className='bg-white rounded-x1 p-4 sm:p-5 shadow-sm border border-purple-100'>
                <h3 className=' text-base sm:text-1g font-semibold mb-3 sm:mb-4 text-gray-800 flex
                items-center gap-2'>
                  ...
                  {tasks.slice(0, 3).map((task) => (
                    ...
                    transition-colors duration-200 border border-transparent hover: border-purple-100'>
                      <div className=' flex-1 min-w-0'>
                        ...
                        <p className=' text-xs Otext-gray-500 mt-0.5'>
