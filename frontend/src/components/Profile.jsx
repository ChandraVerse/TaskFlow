...
import { BACK_BUTTON, FULL_BUTTON, INPUT_WRAPPER, personalFields, securityFields, SECTION_WRAPPER, DANGER_BTN } from '../assets/dummy'
...
const Profile = ({ setCurrentUser, onLogout }) => {
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || "Password Changed failed")
    }
  }
      ...
      <div className=' max-w-4x1 mx-auto p-6'>
        ...
        <div className=' flex items-center gap-4 mb-8'>
            <div className=' w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600
             flex items-center justify-center text-white text-2x1 font-bold shadow-md'>
              {profile.name ? profile. name[0].toUpperCase() : "U"}
            </div>
            <div>
              <h1 className=' text-3x1 font-bold text-gray-800'>Account Settings</h1>
        ...
        <div className=' grid md: grid-cols-2 gap-8'>
          <section className={SECTION_WRAPPER}>
            <div className=' flex items-center gap-2 mb-6'>
              ...
              <h2 className=' text-x1 font-semibold text-gray-800' >Personal Information</h2>
            </div>
          ...
          <section className={SECTION_WRAPPER}>
            <div className=' flex items-center gap-2 mb-6'>
              ...
              <h2 className=' text-x1 font-semibold text-gray-800'>Security</h2>
            </div>
